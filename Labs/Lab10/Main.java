...
// Passenger[] passengers = { new Passenger("Joe"), new Passenger("Sid"), new
// Passenger("Lou"),
...
// Vehicle[] vehicles = {
// new Vehicle("RLM01", getRandomNumber(1, 100), getRandomNumber(1, 100),
// getRandomNumber(1, 100)),
// new Vehicle("MYA04", getRandomNumber(1, 100), getRandomNumber(1, 100),
// getRandomNumber(1, 100)),
// new Vehicle("CTJ02", getRandomNumber(1, 100), getRandomNumber(1, 100),
// getRandomNumber(1, 100)) };
// int i = 0;
...
// Vehicle v6 = new Vehicle("CTJ02", getRandomNumber(1, 5), getRandomNumber(1,
