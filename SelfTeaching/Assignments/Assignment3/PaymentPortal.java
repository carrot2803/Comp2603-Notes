...
public class PaymentPortal extends javax.swing.JFrame {
				...
				logonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(logonPanelLayout.createSequentialGroup()
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 31,
										Short.MAX_VALUE)
								.addGroup(
										logonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(usernameLabel)
								...
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										...
										.addGroup(layout.createSequentialGroup()
												...
												.addGroup(layout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
																false)
														.addComponent(billPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
		...
		layout.setVerticalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup()
								...
								.addComponent(mainLabel)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(logonPanel, javax.swing.GroupLayout.PREFERRED_SIZE,
	...
	private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (!username.equals("") && !password.equals("")) {
			boolean renterIsValid = paymentsystem.validateRenter(username, password);

			if (!renterIsValid) {
				paymentsystem.registerRenter(username, password);
				logonPanelLabel.setText("New Renter Registered");
			} else {
				logonPanelLabel.setText("Unable to Add Renter/Renter Exists");
			}
	...
	private void logonButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_logonButtonActionPerformed
		...
		if (!username.equals("") && !password.equals("")) {
			...
			if (!renterIsValid) {
				logonPanelLabel.setText("Incorrect Username/Password");
			} else {
				setUpBillPanel();
	...
	private void sortByAmountButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_sortByAmountButtonActionPerformed
		...
		billJList.setModel(new javax.swing.AbstractListModel<String>() {
			String[] strings = paymentsystem.getSortedRenterBillsByAmount(username, password).split("\n");
	...
	// Not sure working but is suppose to sort the bill from paid and unpaid but i
	// think its incorrect.
	private void sortByPaidButtonActionPerformed(java.awt.event.ActionEvent evt) {
		String username = userNameField.getText().toString();
		String password = passwordField.getText().toString();

		billJList.setModel(new javax.swing.AbstractListModel<String>() {
			String[] strings = paymentsystem.getSortedRenterBillsByPaid(username, password).split("\n");
	...
	private void setUpBillPanel() {
		...
		billJList.setModel(new javax.swing.AbstractListModel<String>() {
			String[] strings = paymentsystem.getRenterBills(username, password).split("\n");
